...
<section>
   ...
   <?php 
    $data = json_decode(file_get_contents('shenghuozhao.json'), true);
    $data = $data['img'];
    foreach ($data as $k => $v) {
    ?>
        <li><a href='public/images/meipai/shenghuozhao/large/<?php echo $v["big_img"];?>?20151105'><img src='public/images/meipai/shenghuozhao/small/<?php echo $v["small_img"];?>?20151105'/></a></li>
    <?php
        }
    ?>
    </ul>
